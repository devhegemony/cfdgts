/* CFDG Parser - Generated with Chevrotain */
...
var chevrotain = (function() {
  ...
  */
  ...
  return {
    ...
    EMPTY_ALT: MT,
    EOF: vt,
    EarlyExitException: Ur,
    EmbeddedActionsParser: Zo,
    GAstVisitor: ct,
    LLkLookaheadStrategy: Dr,
    Lexer: it,
    LexerDefinitionErrorType: B,
    MismatchedTokenException: ve,
    NoViableAltException: wr,
    NonTerminal: P,
    NotAllInputParsedException: Fr,
    Option: U,
    Parser: Rf,
    ParserDefinitionErrorType: rt,
    Repetition: L,
    RepetitionMandatory: Y,
    RepetitionMandatoryWithSeparator: q,
    RepetitionWithSeparator: H,
    Rule: mt,
    Terminal: C,
    VERSION: jr,
    clearCache: jw,
    createSyntaxDiagramsCode: $T,
    createToken: bn,
    createTokenInstance: Ce,
    defaultLexerErrorProvider: vo,
    defaultParserErrorProvider: Pn,
    generateCstDts: jT,
    getLookaheadPaths: xT,
    isRecognitionException: Te,
    serializeGrammar: Rn,
    serializeProduction: er,
    tokenLabel: Ne,
    tokenMatcher: bo,
    tokenName: pT
  };
